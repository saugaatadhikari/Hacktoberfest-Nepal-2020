...
1. **Star this repository and Follow me on Github [here](https://github.com/Saugat-Adhikari/).**
2. **Navigate to `Add_Your_Info_Here.json` file**
   ![](resources/1.png)
3. **Edit the file, copy paste a json object from above contribution, write your information .**
   ![](resources/2.png)
   ![](resources/3.png)
...
I have created a simple page to display all contributors list [here](https://hacktoberfestnepal.netlify.app/), your name should appear shortly after the pull request is merged.
